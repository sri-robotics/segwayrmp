...
#ifndef RMP_COMMAND_H
#define RMP_COMMAND_H

namespace segway
{
  /**
   * Define Rmp Message Ids
   * Please read the rmp user manual (for instance, page 38 of the RMP 440LE manual)
   */
  enum RmpMessageId
  {
    STANDARD_MOTION = 0x500,
    CONFIGURATION_CMD,
    CAN_RMP_RESP,
    OMNI_MOTION = 0x600
  };
