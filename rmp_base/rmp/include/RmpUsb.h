...
namespace segway
{
   ...
   */
  class RmpUsb: public RmpTransport
  {
  public:
    /**
     * @defgroup segway_RmpUsb_RmpUsb_throw ExceptionTitle
     * @throw std::runtime_error if unable to open the serial port
     */
    
    /**
     * Constructor
     * @param rDevicePort device port
